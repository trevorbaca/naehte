...
# 1
music = baca.make_skeleton_function(r"{ c4. c8 c32 [ c c c ] }")
voice.extend(music)
...
# (11, 13)
music = baca.make_skeleton_function("{" r" c1" r" \times 4/5 { c4 c1 }" r" c2" " }")
voice.extend(music)
...
# 16
music = baca.make_skeleton_function("{ c1 }")
voice.extend(music)
...
# 18
music = baca.make_skeleton_function("{ c4 c c c c c }")
voice.extend(music)
