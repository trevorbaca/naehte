...
def vc(cache):
    ...
    with baca.scope(m[1]) as o:
        baca.hairpin(
            o.rleaves(),
            "o< pp > ppp < f",
            the_pieces=baca.select.lparts(o.rleaves(), [6, 6, 2]),
        )
    ...
    with baca.scope(m.get(2, 3)) as o:
        ...
        baca.text_spanner(
            ...
            bookend=False,
            the_pieces=baca.select.lparts(leaves, [1, 1, 11]),
        )
    with baca.scope(m[4]) as o:
        ...
        with baca.scope(o.rleaves()) as u:
            baca.hairpin(
                ...
                'o< "f" >',
                bookend=False,
                the_pieces=baca.select.lparts(u, [1, 3]),
            )
            baca.text_spanner(
                u,
                r"\baca-damp-markup =|",
    ...
    with baca.scope(m[7]) as o:
        ...
        baca.hairpin(
            o.rleaves(),
            "p > ppp < pp",
            the_pieces=baca.select.lparts(o.rleaves(), [5, 2]),
        )
        baca.literal(
            o.leaf(0),
    ...
    with baca.scope(m.get(5, 7)) as o:
        baca.text_spanner(
            ...
            abjad.Tweak(r"- \tweak staff-padding 5.5"),
            bookend=False,
            the_pieces=baca.select.lparts(o, [1, 5, 7]),
        )
    ...
    with baca.scope(m[10]) as o:
        ...
        with baca.scope(o.rleaves()) as u:
            baca.hairpin(
                u,
                "<| p |>o niente",
                the_pieces=baca.select.lparts(u, [2, 3]),
            )
            baca.text_spanner(
                u,
                ...
                abjad.Tweak(r"- \tweak staff-padding 5.5"),
                bookend=False,
                the_pieces=baca.select.lparts(u, [1, 1, 3]),
            )
        baca.literal(
            o.leaf(0),
