...
def vc(cache):
    ...
    with baca.scope(m[6]) as o:
        ...
        baca.spanners.text(
            ...
            "no scr. -> scr. poss. =|",
            baca.tweak.bound_details_right_padding(4.25, index=0),
    ...
    with baca.scope(m.get(7, 8)) as o:
        ...
        baca.spanners.text(
            ...
            baca.tweak.bound_details_right_padding(1.25, index=0),
            baca.tweak.style_trill(index=0),
            baca.tweak.bound_details_right_padding(2, index=1),
            baca.tweak.bound_details_left_padding(-0.5, index=2),
            baca.tweak.bound_details_right_padding(1.25, index=2),
