...
G_Cello_Music_Voice = {                                                        %! extern

    {
        ...
        % [G Cello_Music_Voice measure 55 / measure 1]                         %! _comment_measure_numbers
...

    {
        ...
        % [G Cello_Music_Voice measure 56 / measure 2]                         %! _comment_measure_numbers
...

    {
        ...
        % [G Cello_Music_Voice measure 57 / measure 3]                         %! _comment_measure_numbers
        <e, c>4
        - \tweak color #(x11-color 'blue)                                      %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
        \ppp                                                                   %! EXPLICIT_DYNAMIC:_set_status_tag:baca_hairpin:PiecewiseCommand(1)
        - \tweak color #(x11-color 'blue)                                      %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
...

    {
        ...
        % [G Cello_Music_Voice measure 58 / measure 4]                         %! _comment_measure_numbers
...

    {
        ...
        % [G Cello_Music_Voice measure 59 / measure 5]                         %! _comment_measure_numbers
        ef,!2..
        - \tweak color #(x11-color 'blue)                                      %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
        \ppp                                                                   %! EXPLICIT_DYNAMIC:_set_status_tag:baca_hairpin:PiecewiseCommand(1)
        - \tweak color #(x11-color 'blue)                                      %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    ...
    \times 7/6 {
        ...
        % [G Cello_Music_Voice measure 60 / measure 6]                         %! _comment_measure_numbers
        \override NoteHead.style = #'harmonic                                  %! baca_note_head_style_harmonic:OverrideCommand(1)
        d,2.
        - \tweak color #(x11-color 'blue)                                      %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
        \ppp                                                                   %! EXPLICIT_DYNAMIC:_set_status_tag:baca_hairpin:PiecewiseCommand(1)
