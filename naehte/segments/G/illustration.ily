G_Global_Rests = {                                                             %! extern
    ...
    % [G Global_Rests measure 79 / measure 1]                                  %! _comment_measure_numbers
    R1 * 9/4                                                                   %! _make_global_rests

    % [G Global_Rests measure 80 / measure 2]                                  %! _comment_measure_numbers
    R1 * 3/8                                                                   %! _make_global_rests

    % [G Global_Rests measure 81 / measure 3]                                  %! _comment_measure_numbers
    R1 * 3/8                                                                   %! _make_global_rests

    % [G Global_Rests measure 82 / measure 4]                                  %! _comment_measure_numbers
    R1 * 3/8                                                                   %! _make_global_rests

    % [G Global_Rests measure 83 / measure 5]                                  %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests

    % [G Global_Rests measure 84 / measure 6]                                  %! _comment_measure_numbers
...
G_Global_Skips = {                                                             %! extern
    ...
    % [G Global_Skips measure 79 / measure 1]                                  %! _comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [G Global_Skips measure 80 / measure 2]                                  %! _comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [G Global_Skips measure 81 / measure 3]                                  %! _comment_measure_numbers
    s1 * 3/8                                                                   %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER_MARKUP
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER_MARKUP
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [G Global_Skips measure 82 / measure 4]                                  %! _comment_measure_numbers
    s1 * 3/8                                                                   %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER_MARKUP
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER_MARKUP
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [G Global_Skips measure 83 / measure 5]                                  %! _comment_measure_numbers
...
%@% \bacaStartTextSpanLMI                                                      %! LOCAL_MEASURE_INDEX_MARKUP
    ...
    \bacaStartTextSpanLMN                                                      %! LOCAL_MEASURE_NUMBER_MARKUP
%@% - \baca-start-mn-both "83" "84"                                            %! MEASURE_NUMBER_MARKUP
%@% \bacaStartTextSpanMN                                                       %! MEASURE_NUMBER_MARKUP
%@% - \baca-start-ct-both "[0'09'']" "[0'14'']"                                %! CLOCK_TIME_MARKUP
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP

    % [G Global_Skips measure 84 / measure 6]                                  %! _comment_measure_numbers
...
G_Cello_Music_Voice = {                                                        %! extern

    {
        ...
        % [G Cello_Music_Voice measure 79 / measure 1]                         %! _comment_measure_numbers
...

    {
        ...
        % [G Cello_Music_Voice measure 80 / measure 2]                         %! _comment_measure_numbers
...

    {
        ...
        % [G Cello_Music_Voice measure 81 / measure 3]                         %! _comment_measure_numbers
        <e, c>4
        - \tweak color #(x11-color 'blue)                                      %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
        \ppp                                                                   %! EXPLICIT_DYNAMIC:_set_status_tag:baca_hairpin:PiecewiseCommand(1)
        - \tweak color #(x11-color 'blue)                                      %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
...

    {
        ...
        % [G Cello_Music_Voice measure 82 / measure 4]                         %! _comment_measure_numbers
...

    {
        ...
        % [G Cello_Music_Voice measure 83 / measure 5]                         %! _comment_measure_numbers
        ef,!2..
        - \tweak color #(x11-color 'blue)                                      %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
        \ppp                                                                   %! EXPLICIT_DYNAMIC:_set_status_tag:baca_hairpin:PiecewiseCommand(1)
        - \tweak color #(x11-color 'blue)                                      %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    ...
    \times 7/6 {
        ...
        % [G Cello_Music_Voice measure 84 / measure 6]                         %! _comment_measure_numbers
        \override NoteHead.style = #'harmonic                                  %! baca_note_head_style_harmonic:OverrideCommand(1)
        d,2.
        - \tweak color #(x11-color 'blue)                                      %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
        \ppp                                                                   %! EXPLICIT_DYNAMIC:_set_status_tag:baca_hairpin:PiecewiseCommand(1)
