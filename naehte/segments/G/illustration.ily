...
%@% \bacaStartTextSpanMN                                                       %! MEASURE_NUMBER_MARKUP
%@% - \baca-start-ct-both "[0'35'']" "[0'40'']"                                %! CLOCK_TIME_MARKUP
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
...
G_Cello_Music_Voice = {                                                        %! extern
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Cello_Rest_Voice measure 95 / measure 7]                      %! _comment_measure_numbers
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [G Cello_Rest_Voice measure 99 / measure 11]                     %! _comment_measure_numbers
