F_Global_Rests = {                                                             %! extern
    ...
    % [F Global_Rests measure 58 / measure 1]                                  %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests

    % [F Global_Rests measure 59 / measure 2]                                  %! _comment_measure_numbers
    R1 * 3/2                                                                   %! _make_global_rests

    % [F Global_Rests measure 60 / measure 3]                                  %! _comment_measure_numbers
    R1 * 3/8                                                                   %! _make_global_rests

    % [F Global_Rests measure 61 / measure 4]                                  %! _comment_measure_numbers
    R1 * 5/8                                                                   %! _make_global_rests

    % [F Global_Rests measure 62 / measure 5]                                  %! _comment_measure_numbers
...
F_Global_Skips = {                                                             %! extern
    ...
    \repeat volta 2
    {
        ...
        % [F Global_Skips measure 58 / measure 1]                              %! _comment_measure_numbers
    ...
    \repeat volta 2
    {
        ...
        % [F Global_Skips measure 59 / measure 2]                              %! _comment_measure_numbers
    ...
    %@% \bacaStartTextSpanCT                                                   %! CLOCK_TIME_MARKUP
        ...
        % [F Global_Skips measure 60 / measure 3]                              %! _comment_measure_numbers
    ...
    %@% \bacaStartTextSpanCT                                                   %! CLOCK_TIME_MARKUP
        ...
        % [F Global_Skips measure 61 / measure 4]                              %! _comment_measure_numbers
    ...
    % [F Global_Skips measure 62 / measure 5]                                  %! _comment_measure_numbers
...
F_Cello_Music_Voice = {                                                        %! extern

    {
        ...
        % [F Cello_Music_Voice measure 58 / measure 1]                         %! _comment_measure_numbers
    ...
    \times 6/7 {
        ...
        \times 4/5 {
            ...
            % [F Cello_Music_Voice measure 59 / measure 2]                     %! _comment_measure_numbers
            <b fs'!>4
...

    {
        ...
        % [F Cello_Music_Voice measure 60 / measure 3]                         %! _comment_measure_numbers
        ds!4
        - \tweak color #(x11-color 'blue)                                      %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
...

    {
        ...
        % [F Cello_Music_Voice measure 61 / measure 4]                         %! _comment_measure_numbers
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [F Cello_Music_Voice measure 62 / measure 5]                     %! _comment_measure_numbers
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [F Cello_Rest_Voice measure 62 / measure 5]                      %! _comment_measure_numbers
