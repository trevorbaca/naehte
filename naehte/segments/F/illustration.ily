F_Global_Rests = {                                                             %! extern
    ...
    % [F Global_Rests measure 70 / measure 1]                                  %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests

    % [F Global_Rests measure 71 / measure 2]                                  %! _comment_measure_numbers
    R1 * 3/2                                                                   %! _make_global_rests

    % [F Global_Rests measure 72 / measure 3]                                  %! _comment_measure_numbers
    R1 * 3/8                                                                   %! _make_global_rests

    % [F Global_Rests measure 73 / measure 4]                                  %! _comment_measure_numbers
    R1 * 5/8                                                                   %! _make_global_rests

    % [F Global_Rests measure 74 / measure 5]                                  %! _comment_measure_numbers
...
F_Global_Skips = {                                                             %! extern
    ...
    \repeat volta 2
    {
        ...
        % [F Global_Skips measure 70 / measure 1]                              %! _comment_measure_numbers
    ...
    \repeat volta 2
    {
        ...
        % [F Global_Skips measure 71 / measure 2]                              %! _comment_measure_numbers
    ...
    %@% \bacaStartTextSpanCT                                                   %! CLOCK_TIME_MARKUP
        ...
        % [F Global_Skips measure 72 / measure 3]                              %! _comment_measure_numbers
    ...
    %@% \bacaStartTextSpanCT                                                   %! CLOCK_TIME_MARKUP
        ...
        % [F Global_Skips measure 73 / measure 4]                              %! _comment_measure_numbers
    ...
    % [F Global_Skips measure 74 / measure 5]                                  %! _comment_measure_numbers
...
F_Cello_Music_Voice = {                                                        %! extern

    {
        ...
        % [F Cello_Music_Voice measure 70 / measure 1]                         %! _comment_measure_numbers
    ...
    \times 6/7 {
        ...
        \times 4/5 {
            ...
            % [F Cello_Music_Voice measure 71 / measure 2]                     %! _comment_measure_numbers
            <b fs'!>4
...

    {
        ...
        % [F Cello_Music_Voice measure 72 / measure 3]                         %! _comment_measure_numbers
        ds!4
        - \tweak color #(x11-color 'blue)                                      %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
...

    {
        ...
        % [F Cello_Music_Voice measure 73 / measure 4]                         %! _comment_measure_numbers
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [F Cello_Music_Voice measure 74 / measure 5]                     %! _comment_measure_numbers
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [F Cello_Rest_Voice measure 74 / measure 5]                      %! _comment_measure_numbers
