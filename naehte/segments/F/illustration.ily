F_Global_Skips = {                                                             %! abjad.Path.extern
    ...
    - \baca-rehearsal-mark-markup "F"                                          %! baca.rehearsal_mark():+SEGMENT:IndicatorCommand
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    \time 11/4                                                                 %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:baca.SegmentMaker._make_global_skips(2)
    \baca-time-signature-color #'blue                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:baca.SegmentMaker._attach_color_literal(2)
...
%@% \bacaStartTextSpanMN                                                       %! MEASURE_NUMBER
%@% - \baca-start-ct-both-left-fermata "2''" "[6'07'']"                        %! CLOCK_TIME
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
...
F_Cello_Music_Voice = {                                                        %! abjad.Path.extern
    ...
    {                                                                          %! baca.skeleton()
        ...
        \times 2/3 {                                                           %! baca.skeleton()
            ...
            \override TupletBracket.padding = #1.75                            %! baca.tuplet_bracket_padding():OverrideCommand(1)
            f,32                                                               %! baca.skeleton()
            - \tweak color #(x11-color 'blue)                                  %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
        ...
        - \tweak bound-details.right.padding #7.25                             %! baca.text_spanner:PiecewiseCommand(1)
        ...
        \revert TupletBracket.padding                                          %! baca.tuplet_bracket_padding():OverrideCommand(2)
    ...
    \times 3/4 {                                                               %! baca.skeleton()
        ...
        \times 2/3 {                                                           %! baca.skeleton()
            ...
            \once \override TupletBracket.padding = #1.5                       %! baca.tuplet_bracket_padding():OverrideCommand(1)
            gf,!8                                                              %! baca.skeleton()
            - \tweak color #(x11-color 'blue)                                  %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
            \p                                                                 %! EXPLICIT_DYNAMIC:_set_status_tag:SPANNER_STOP:baca.hairpin:PiecewiseCommand(1)
            - \tweak color #(x11-color 'blue)                                  %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container()
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container()
            ...
            \baca-invisible-music                                              %! baca.SegmentMaker._make_multimeasure_rest_container()
            e1 * 1/4                                                           %! baca.SegmentMaker._make_multimeasure_rest_container()
            - \tweak color #(x11-color 'blue)                                  %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
