C_Global_Skips = {                                                             %! abjad.Path.extern
    ...
    \once \override Score.BarLine.X-extent = #'(0 . 2)                         %! MEASURE_28:NOT_MOL:baca.bar_line_x_extent():OverrideCommand(1)
%%% \once \override Score.BarLine.X-extent = #'(0 . 3)                         %! MEASURE_28:ONLY_MOL:baca.bar_line_x_extent():OverrideCommand(1)
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    \bar ":|."                                                                 %! baca.bar_line:IndicatorCommand
    \once \override Score.BarLine.X-extent = #'(0 . 1.5)                       %! MEASURE_30:ONLY_MOL:baca.bar_line_x_extent():OverrideCommand(1)
