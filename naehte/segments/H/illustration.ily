H_Global_Skips = {                                                             %! abjad.Path.extern
    ...
    % [H Global_Skips measure 103 / measure 1]                                 %! _comment_measure_numbers
...
%@% - \baca-start-ct-left-only "[7'14'']"                                      %! CLOCK_TIME
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME

    % [H Global_Skips measure 104 / measure 2]                                 %! _comment_measure_numbers
    s1 * 9/4                                                                   %! _make_global_skips(1)
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [H Global_Skips measure 105 / measure 3]                                 %! _comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [H Global_Skips measure 106 / measure 4]                                 %! _comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [H Global_Skips measure 107 / measure 5]                                 %! _comment_measure_numbers
...
%@% \bacaStartTextSpanMM                                                       %! EXPLICIT_METRONOME_MARK:_set_status_tag:_attach_metronome_marks(2)
    ...
    \bacaStartTextSpanMM                                                       %! EXPLICIT_METRONOME_MARK_WITH_COLOR:_attach_metronome_marks(3)
%@% - \baca-start-ct-left-only "[7'26'']"                                      %! CLOCK_TIME
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME

    % [H Global_Skips measure 108 / measure 6]                                 %! _comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [H Global_Skips measure 109 / measure 7]                                 %! _comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [H Global_Skips measure 110 / measure 8]                                 %! _comment_measure_numbers
    s1 * 3/4                                                                   %! _make_global_skips(1)
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER
%@% \bacaStopTextSpanCT                                                        %! CLOCK_TIME
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [H Global_Skips measure 111 / measure 9]                                 %! _comment_measure_numbers
    \time 1/4                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca-time-signature-color #'blue                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1/4                                                                   %! _make_global_skips(1)
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [H Global_Skips measure 112 / measure 10]                                %! _comment_measure_numbers
    \time 6/8                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca-time-signature-color #'blue                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 3/4                                                                   %! _make_global_skips(1)
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [H Global_Skips measure 113 / measure 11]                                %! _comment_measure_numbers
    s1 * 3/4                                                                   %! _make_global_skips(1)
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER
%@% \bacaStopTextSpanCT                                                        %! CLOCK_TIME
...
%@% \bacaStartTextSpanMN                                                       %! MEASURE_NUMBER
%@% - \baca-start-ct-left-only "[7'43'']"                                      %! CLOCK_TIME
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME

    % [H Global_Skips measure 114 / measure 12]                                %! _comment_measure_numbers
...
%@% \bacaStartTextSpanMN                                                       %! MEASURE_NUMBER
%@% - \baca-start-ct-left-only "[7'45'']"                                      %! CLOCK_TIME
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME

    % [H Global_Skips measure 115 / measure 13]                                %! _comment_measure_numbers
    \time 6/8                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca-time-signature-color #'blue                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 3/4                                                                   %! _make_global_skips(1)
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    % [H Global_Skips measure 116 / measure 14]                                %! _comment_measure_numbers
    \time 1/4                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca-time-signature-color #'blue                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1/4                                                                   %! _make_global_skips(1)
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER
...
%@% \bacaStartTextSpanMN                                                       %! MEASURE_NUMBER
%@% - \baca-start-ct-both-left-fermata "2''" "[7'50'']"                        %! CLOCK_TIME
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    \baca-bar-line-visible                                                     %! _attach_final_bar_line
    \bar "|."                                                                  %! _attach_final_bar_line

    % [H Global_Skips measure 117 / measure 15]                                %! PHANTOM:_style_phantom_measures(1):_comment_measure_numbers
...
H_Global_Rests = {                                                             %! abjad.Path.extern
    ...
    % [H Global_Rests measure 103 / measure 1]                                 %! _comment_measure_numbers
    R1 * 9/4                                                                   %! _make_global_rests(1)

    % [H Global_Rests measure 104 / measure 2]                                 %! _comment_measure_numbers
    R1 * 9/4                                                                   %! _make_global_rests(1)

    % [H Global_Rests measure 105 / measure 3]                                 %! _comment_measure_numbers
    R1 * 5/8                                                                   %! _make_global_rests(1)

    % [H Global_Rests measure 106 / measure 4]                                 %! _comment_measure_numbers
    \baca-fermata-measure                                                      %! baca.global_fermata:GlobalFermataCommand(2)
    R1 * 1/4                                                                   %! _make_global_rests(1)
    ^ \baca-fermata-markup                                                     %! baca.global_fermata:GlobalFermataCommand(1)

    % [H Global_Rests measure 107 / measure 5]                                 %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [H Global_Rests measure 108 / measure 6]                                 %! _comment_measure_numbers
    R1 * 5/4                                                                   %! _make_global_rests(1)

    % [H Global_Rests measure 109 / measure 7]                                 %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _make_global_rests(1)

    % [H Global_Rests measure 110 / measure 8]                                 %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _make_global_rests(1)

    % [H Global_Rests measure 111 / measure 9]                                 %! _comment_measure_numbers
    \baca-fermata-measure                                                      %! baca.global_fermata:GlobalFermataCommand(2)
    R1 * 1/4                                                                   %! _make_global_rests(1)
    ^ \baca-fermata-markup                                                     %! baca.global_fermata:GlobalFermataCommand(1)

    % [H Global_Rests measure 112 / measure 10]                                %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _make_global_rests(1)

    % [H Global_Rests measure 113 / measure 11]                                %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _make_global_rests(1)

    % [H Global_Rests measure 114 / measure 12]                                %! _comment_measure_numbers
    R1 * 7/8                                                                   %! _make_global_rests(1)

    % [H Global_Rests measure 115 / measure 13]                                %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _make_global_rests(1)

    % [H Global_Rests measure 116 / measure 14]                                %! _comment_measure_numbers
    \baca-fermata-measure                                                      %! baca.global_fermata:GlobalFermataCommand(2)
    R1 * 1/4                                                                   %! _make_global_rests(1)
    ^ \baca-fermata-markup                                                     %! baca.global_fermata:GlobalFermataCommand(1)

    % [H Global_Rests measure 117 / measure 15]                                %! PHANTOM:_style_phantom_measures(4):_comment_measure_numbers
...
H_Cello_Music_Voice = {                                                        %! abjad.Path.extern
    ...
    {                                                                          %! baca.skeleton
        ...
        \override NoteHead.style = #'harmonic-black                            %! baca.note_head_style_harmonic_black:OverrideCommand(1)
    ...
    {                                                                          %! baca.skeleton
        ...
        % [H Cello_Music_Voice measure 104 / measure 2]                        %! _comment_measure_numbers
        \override NoteHead.style = #'harmonic-black                            %! baca.note_head_style_harmonic_black:OverrideCommand(1)
        df,!1                                                                  %! baca.skeleton
        :32                                                                    %! baca.stem_tremolo:IndicatorCommand
        - \tweak color #(x11-color 'blue)                                      %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
        ...
        \glissando                                                             %! baca.glissando
        - \abjad-dashed-line-with-hook                                         %! baca.text_spanner:PiecewiseCommand(1)
        - \baca-text-spanner-left-text "½ clt"                                 %! baca.text_spanner:PiecewiseCommand(1)
        - \tweak staff-padding #3                                              %! baca.text_spanner:PiecewiseCommand(1)
        \startTextSpan                                                         %! baca.text_spanner:PiecewiseCommand(1)
    ...
    {                                                                          %! baca.skeleton
        ...
        % [H Cello_Music_Voice measure 105 / measure 3]                        %! _comment_measure_numbers
        c,2                                                                    %! baca.skeleton
        - \tweak color #(x11-color 'blue)                                      %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [H Cello_Music_Voice measure 106 / measure 4]                    %! _comment_measure_numbers
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [H Cello_Rest_Voice measure 106 / measure 4]                     %! _comment_measure_numbers
    ...
    {                                                                          %! baca.skeleton
        ...
        \times 3/4 {                                                           %! baca.skeleton
            ...
            \times 2/3 {                                                       %! baca.skeleton
                ...
                \once \override TupletBracket.staff-padding = #2.5             %! baca.tuplet_bracket_staff_padding:OverrideCommand(1)
                b,4                                                            %! baca.skeleton
                - \tweak color #(x11-color 'blue)                              %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    ...
    {                                                                          %! baca.skeleton
        ...
        % [H Cello_Music_Voice measure 108 / measure 6]                        %! _comment_measure_numbers
        e,1                                                                    %! baca.skeleton
        - \tweak color #(x11-color 'blue)                                      %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
        \mp                                                                    %! EXPLICIT_DYNAMIC:_set_status_tag:baca.hairpin:PiecewiseCommand(1)
        - \tweak color #(x11-color 'blue)                                      %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    ...
    \times 6/7 {                                                               %! baca.skeleton
        ...
        \once \override DynamicText.self-alignment-X = #-0.5                   %! baca.dynamic_text_self_alignment_x:OverrideCommand(1)
        ...
        - \tweak bound-details.left.padding #-0.5                              %! baca.text_spanner:PiecewiseCommand(1)
    ...
    \times 6/7 {                                                               %! baca.skeleton
        ...
        % [H Cello_Music_Voice measure 110 / measure 8]                        %! _comment_measure_numbers
        <f c'>2.
        \stopTextSpanOne                                                       %! baca.text_spanner:PiecewiseCommand(1)
        \stopTextSpan                                                          %! baca.text_spanner:PiecewiseCommand(1)
        - \abjad-dashed-line-with-hook                                         %! baca.text_spanner:PiecewiseCommand(1)
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [H Cello_Music_Voice measure 111 / measure 9]                    %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
            c'1 * 1/4                                                          %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [H Cello_Rest_Voice measure 111 / measure 9]                     %! _comment_measure_numbers
            R1 * 1/4                                                           %! _make_multimeasure_rest_container
    ...
    {                                                                          %! baca.skeleton
        ...
        \once \override DynamicText.self-alignment-X = #-0.45                  %! baca.dynamic_text_self_alignment_x:OverrideCommand(1)
        \override Dots.extra-offset = #'(0.5 . 1)                              %! baca.dots_extra_offset:OverrideCommand(1)
        ...
        - \abjad-dashed-line-with-hook                                         %! baca.text_spanner:PiecewiseCommand(1)
        - \baca-text-spanner-left-text "XFB"                                   %! baca.text_spanner:PiecewiseCommand(1)
        - \tweak bound-details.left.padding #-2                                %! baca.text_spanner:PiecewiseCommand(1)
        - \tweak bound-details.right.padding #3.25                             %! baca.text_spanner:PiecewiseCommand(1)
        - \tweak staff-padding #3                                              %! baca.text_spanner:PiecewiseCommand(1)
        \startTextSpan                                                         %! baca.text_spanner:PiecewiseCommand(1)

        % [H Cello_Music_Voice measure 113 / measure 11]                       %! _comment_measure_numbers
        ...
        % [H Cello_Music_Voice measure 114 / measure 12]                       %! _comment_measure_numbers
        e2..                                                                   %! baca.skeleton
        - \abjad-zero-padding-glissando                                        %! baca.glissando
        \glissando                                                             %! baca.glissando

        % [H Cello_Music_Voice measure 115 / measure 13]                       %! _comment_measure_numbers
        e2.                                                                    %! baca.skeleton
        - \abjad-zero-padding-glissando                                        %! baca.glissando
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            % [H Cello_Music_Voice measure 116 / measure 14]                   %! _comment_measure_numbers
            \baca-invisible-music                                              %! _make_multimeasure_rest_container
            ef!1 * 1/4                                                         %! _make_multimeasure_rest_container
            - \tweak color #(x11-color 'blue)                                  %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [H Cello_Music_Voice measure 117 / measure 15]                   %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
