H_Global_Rests = {                                                             %! extern
    ...
    % [H Global_Rests measure 85 / measure 1]                                  %! _comment_measure_numbers
    R1 * 9/4                                                                   %! _make_global_rests

    % [H Global_Rests measure 86 / measure 2]                                  %! _comment_measure_numbers
    R1 * 9/4                                                                   %! _make_global_rests

    % [H Global_Rests measure 87 / measure 3]                                  %! _comment_measure_numbers
    R1 * 5/8                                                                   %! _make_global_rests

    % [H Global_Rests measure 88 / measure 4]                                  %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _make_global_rests

    % [H Global_Rests measure 89 / measure 5]                                  %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _make_global_rests

    % [H Global_Rests measure 90 / measure 6]                                  %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _make_global_rests
...
H_Global_Skips = {                                                             %! extern
    ...
    % [H Global_Skips measure 85 / measure 1]                                  %! _comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [H Global_Skips measure 86 / measure 2]                                  %! _comment_measure_numbers
    s1 * 9/4                                                                   %! _make_global_skips(1)
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [H Global_Skips measure 87 / measure 3]                                  %! _comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [H Global_Skips measure 88 / measure 4]                                  %! _comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [H Global_Skips measure 89 / measure 5]                                  %! _comment_measure_numbers
    s1 * 3/4                                                                   %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER_MARKUP
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER_MARKUP
...
%@% \bacaStartTextSpanLMI                                                      %! LOCAL_MEASURE_INDEX_MARKUP
    ...
    \bacaStartTextSpanLMN                                                      %! LOCAL_MEASURE_NUMBER_MARKUP
%@% - \baca-start-mn-both "89" "90"                                            %! MEASURE_NUMBER_MARKUP
%@% \bacaStartTextSpanMN                                                       %! MEASURE_NUMBER_MARKUP
%@% - \baca-start-ct-both "[0'12'']" "[0'13'']"                                %! CLOCK_TIME_MARKUP
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP

    % [H Global_Skips measure 90 / measure 6]                                  %! _comment_measure_numbers
    s1 * 3/4                                                                   %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER_MARKUP
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER_MARKUP
...
H_Cello_Music_Voice = {                                                        %! extern

    {
        ...
        % [H Cello_Music_Voice measure 85 / measure 1]                         %! _comment_measure_numbers
...

    {
        ...
        % [H Cello_Music_Voice measure 86 / measure 2]                         %! _comment_measure_numbers
        \override NoteHead.style = #'harmonic-black                            %! baca_note_head_style_harmonic_black:OverrideCommand(1)
        df,!1
        :32                                                                    %! baca_stem_tremolo:IndicatorCommand
        - \tweak color #(x11-color 'blue)                                      %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
...

    {
        ...
        % [H Cello_Music_Voice measure 87 / measure 3]                         %! _comment_measure_numbers
        c,2
        - \tweak color #(x11-color 'blue)                                      %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
...

    {
        ...
        \times 6/7 {
            ...
            % [H Cello_Music_Voice measure 88 / measure 4]                     %! _comment_measure_numbers
        ...
        \times 6/7 {
            ...
            % [H Cello_Music_Voice measure 89 / measure 5]                     %! _comment_measure_numbers
            <f c'>2.
            \stopTextSpanOne                                                   %! baca_text_spanner:PiecewiseCommand(1)
            \stopTextSpan                                                      %! baca_text_spanner:PiecewiseCommand(1)
            - \abjad-dashed-line-with-hook                                     %! baca_text_spanner:PiecewiseCommand(1)
        ...
        \times 6/7 {
            ...
            % [H Cello_Music_Voice measure 90 / measure 6]                     %! _comment_measure_numbers
            ef!2.
            \stopTextSpanOne                                                   %! baca_text_spanner:PiecewiseCommand(1)
            \stopTextSpan                                                      %! baca_text_spanner:PiecewiseCommand(1)
