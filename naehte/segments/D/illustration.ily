D_Global_Skips = {                                                             %! extern
    ...
    - \tweak extra-offset #'(0 . 14)                                           %! baca_rehearsal_mark:+SEGMENT:IndicatorCommand
    - \baca-rehearsal-mark-markup "D"                                          %! baca_rehearsal_mark:+SEGMENT:IndicatorCommand
...
%@% \bacaStartTextSpanMN                                                       %! MEASURE_NUMBER_MARKUP
%@% - \baca-start-ct-both "[2'54'']" "[3'55'']"                                %! CLOCK_TIME_MARKUP
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
...
D_Cello_Music_Voice = {                                                        %! extern
...

    {
        ...
        \times 6/7 {
            ...
            \once \override TupletBracket.staff-padding = #4.25                %! baca_tuplet_bracket_staff_padding:OverrideCommand(1)
            <f a>2
            - \tweak color #(x11-color 'blue)                                  %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
            \p                                                                 %! EXPLICIT_DYNAMIC:_set_status_tag:baca_hairpin:PiecewiseCommand(1)
            - \tweak color #(x11-color 'blue)                                  %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
