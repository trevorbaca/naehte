D_Global_Rests = {                                                             %! extern
    ...
    % [D Global_Rests measure 29 / measure 1]                                  %! _comment_measure_numbers
    R1 * 5/8                                                                   %! _make_global_rests

    % [D Global_Rests measure 30 / measure 2]                                  %! _comment_measure_numbers
    R1 * 5/8                                                                   %! _make_global_rests

    % [D Global_Rests measure 31 / measure 3]                                  %! _comment_measure_numbers
    R1 * 5/8                                                                   %! _make_global_rests

    % [D Global_Rests measure 32 / measure 4]                                  %! _comment_measure_numbers
    R1 * 2                                                                     %! _make_global_rests

    % [D Global_Rests measure 33 / measure 5]                                  %! _comment_measure_numbers
    R1 * 2                                                                     %! _make_global_rests
...
D_Global_Skips = {                                                             %! extern
    ...
    % [D Global_Skips measure 29 / measure 1]                                  %! _comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    \repeat volta 2
    {
        ...
        % [D Global_Skips measure 30 / measure 2]                              %! _comment_measure_numbers
    ...
    %@% \bacaStartTextSpanCT                                                   %! CLOCK_TIME_MARKUP
        ...
        % [D Global_Skips measure 31 / measure 3]                              %! _comment_measure_numbers
        s1 * 5/8                                                               %! _make_global_skips(1)
    %@% \bacaStopTextSpanLMI                                                   %! LOCAL_MEASURE_INDEX_MARKUP
        \bacaStopTextSpanLMN                                                   %! LOCAL_MEASURE_NUMBER_MARKUP
    %@% \bacaStopTextSpanMN                                                    %! MEASURE_NUMBER_MARKUP
    ...
    % [D Global_Skips measure 32 / measure 4]                                  %! _comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [D Global_Skips measure 33 / measure 5]                                  %! _comment_measure_numbers
    s1 * 2                                                                     %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER_MARKUP
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER_MARKUP
...
D_Cello_Music_Voice = {                                                        %! extern

    {
        ...
        % [D Cello_Music_Voice measure 29 / measure 1]                         %! _comment_measure_numbers
...

    {
        ...
        % [D Cello_Music_Voice measure 30 / measure 2]                         %! _comment_measure_numbers
        \once \override RepeatTie.extra-offset = #'(-1.5 . 0)                  %! baca_repeat_tie_extra_offset:OverrideCommand(1)
        cs!2
        - \tweak color #(x11-color 'blue)                                      %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
...

    {
        ...
        % [D Cello_Music_Voice measure 31 / measure 3]                         %! _comment_measure_numbers
...

    {
        ...
        % [D Cello_Music_Voice measure 32 / measure 4]                         %! _comment_measure_numbers
        cs!4
        - \tweak color #(x11-color 'blue)                                      %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
...

    {
        ...
        % [D Cello_Music_Voice measure 33 / measure 5]                         %! _comment_measure_numbers
        <cs! a>1
        - \tweak color #(x11-color 'blue)                                      %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
        \baca-effort-mf                                                        %! EXPLICIT_DYNAMIC:_set_status_tag:baca_hairpin:PiecewiseCommand(1)
        - \tweak color #(x11-color 'blue)                                      %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
