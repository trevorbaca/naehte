D_Global_Skips = {                                                             %! abjad.Path.extern
    ...
    - \baca-rehearsal-mark-markup "D"                                          %! baca.rehearsal_mark():+SEGMENT:IndicatorCommand
...
%%% \once \override Score.BarLine.X-extent = #'(0 . 2)                         %! MEASURE_50:NOT_MOL:baca.bar_line_x_extent():OverrideCommand(1)
    \once \override Score.BarLine.X-extent = #'(0 . 3)                         %! MEASURE_50:ONLY_MOL:baca.bar_line_x_extent():OverrideCommand(1)
    \time 5/8                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:baca.SegmentMaker._make_global_skips(2)
    \baca-time-signature-color #'blue                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:baca.SegmentMaker._attach_color_literal(2)
    s1 * 5/8                                                                   %! baca.SegmentMaker._make_global_skips(1)
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    \bar ":|."                                                                 %! baca.bar_line():IndicatorCommand
    \once \override Score.BarLine.X-extent = #'(0 . 1.5)                       %! MEASURE_52:ONLY_MOL:baca.bar_line_x_extent():OverrideCommand(1)
...
%@% \bacaStartTextSpanMN                                                       %! MEASURE_NUMBER
%@% - \baca-start-ct-both "[3'56'']" "[4'05'']"                                %! CLOCK_TIME
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
...
D_Cello_Music_Voice = {                                                        %! abjad.Path.extern
    ...
    {                                                                          %! baca.skeleton()
        ...
        \times 6/7 {                                                           %! baca.skeleton()
            ...
            \once \override TupletBracket.staff-padding = #4.25                %! baca.tuplet_bracket_staff_padding():OverrideCommand(1)
            <f a>2
            - \tweak color #(x11-color 'blue)                                  %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
            \p                                                                 %! EXPLICIT_DYNAMIC:_set_status_tag:SPANNER_STOP:baca.hairpin:PiecewiseCommand(1)
            - \tweak color #(x11-color 'blue)                                  %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
            ...
            \times 2/3 {                                                       %! baca.skeleton()
                ...
                \once \override TupletBracket.padding = #1.75                  %! baca.tuplet_bracket_padding():OverrideCommand(1)
                <f a>16
