...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME:baca.SegmentMaker._label_clock_time()
    ...
    % [01 Global_Skips measure 9]                                              %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(1):PHANTOM
...
a_Global_Rests = {                                                             %! ide.Path.extern()
    ...
    % [01 Global_Rests measure 9]                                              %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(4):PHANTOM
...
a_Cello_Music_Voice = {                                                        %! ide.Path.extern()
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container(7):PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container(4):PHANTOM
            ...
            % [01 Cello_Music_Voice measure 9]                                 %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container(6):PHANTOM
            ...
            % [01 Cello_Rest_Voice measure 9]                                  %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
