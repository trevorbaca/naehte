% time_signatures = ['5/8', '3/4', '3/4', '7/4', '7/8']
% measure_count = 5
...
<<                                                                                       %! SingleStaffScoreTemplate
    ...
    <<                                                                                   %! _make_global_context
        ...
        %@% \bacaStartTextSpanSPM                                                        %! SPACING_MARKUP
            ...
            \baca-new-spacing-section #35 #1344                                          %! HorizontalSpacingSpecifier(1):SPACING
            \noBreak                                                                     %! BreakMeasureMap(2):BREAK
            s1 * 3/4                                                                     %! _make_global_skips(1)
        %@% \bacaStopTextSpanSPM                                                         %! SPACING_MARKUP
        %@% - \baca-start-spm-left-only "[[1/56 * 35/24]]"                               %! SPACING_MARKUP
        %@% \bacaStartTextSpanSPM                                                        %! SPACING_MARKUP
        ...
        %@% \bacaStopTextSpanSPM                                                         %! SPACING_MARKUP
        %@% - \baca-start-spm-both "[1/56]" "[[1/32 * 35/24]]"                           %! SPACING_MARKUP
        %@% \bacaStartTextSpanSPM                                                        %! SPACING_MARKUP
