...
<<                                                                             %! baca.SingleStaffScoreTemplate.__call__
    ...
    <<                                                                         %! abjad.ScoreTemplate._make_global_context
        ...
        {   %*% Page_Layout                                                    %! abjad.ScoreTemplate._make_global_context
            ...
            \baca-lbsd #90 #'(16)                                              %! BREAK:IndicatorCommand
        ...
        %@% \bacaStartTextSpanSPM                                              %! SPACING
            ...
            \baca-new-spacing-section #1 #48                                   %! HorizontalSpacingSpecifier(1):SPACING_COMMAND
            \noBreak                                                           %! BreakMeasureMap(2):BREAK
            \baca-lbsd #156 #'(16)                                             %! BREAK:IndicatorCommand
        ...
        %@% \bacaStartTextSpanSPM                                              %! SPACING
            ...
            \baca-new-spacing-section #1 #32                                   %! HorizontalSpacingSpecifier(1):SPACING_COMMAND
            \noBreak                                                           %! BreakMeasureMap(2):BREAK
            \baca-lbsd #222 #'(16)                                             %! BREAK:IndicatorCommand
            \break                                                             %! BREAK:IndicatorCommand
        ...
        %@% \bacaStartTextSpanSPM                                              %! SPACING
            ...
            % [Page_Layout measure 9]                                          %! PHANTOM:baca.SegmentMaker._style_phantom_measures(1):baca.SegmentMaker._comment_measure_numbers
